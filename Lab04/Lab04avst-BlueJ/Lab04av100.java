...
// This the1090 point version of the assignment
...
public class Lab04av100
{
    public static void main(String[] args)
    {
        ...
        double monthlyPaymentC = monthlyPayment % (int) monthlyPayment *100;
        double monthlyChange = (double) (Math.round(monthlyPaymentC))/100;
        monthlyPayment = (int) monthlyPayment + monthlyChange;
