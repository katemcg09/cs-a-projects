...
public class ElevensBoard {
    ...
    public boolean isLegal(List<Integer> selectedCards) {
        ...
        if (selectedCards.size() > 3 || selectedCards.size() < 2){return false;}
        else if(cards[(selectedCards.get(0))].pointValue() + cards[selectedCards.get(1)].pointValue() == 11){
            return true;
        }
        else if(selectedCards.size() > 2){
            if((cards[selectedCards.get(0)].rank() == cards[selectedCards.get(1)].rank() || 
                cards[selectedCards.get(2)].rank() == cards[selectedCards.get(1)].rank() || 
                cards[selectedCards.get(0)].rank() == cards[selectedCards.get(2)].rank())){
                return false;}
            if((cards[selectedCards.get(0)].pointValue() + cards[selectedCards.get(1)].pointValue() + 
                cards[selectedCards.get(2)].pointValue()) == 0){
                return true;
            }
        }
        return false;
    ...
    public boolean anotherPlayIsPossible() {
        ...
        for (int j=i+1; j<cards.length; j++){
            ...
            if (cards[i].rank() == "jack"){
                if (cards[j].rank() == "queen")
                    if (cards[k].rank() == "king")
                                return true;
                else if(cards[j].rank() == "king")
                    if (cards[k].rank() == "queen")
                        return true;
            }
                                
            else if (cards[i].rank() == "queen"){
                if (cards[j].rank() == "jack")
                    if (cards[k].rank() == "king")
                                return true;
                else if(cards[j].rank() == "king")
                    if (cards[k].rank() == "jack")
                        return true;}
