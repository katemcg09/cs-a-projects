...
class Rational
{
    ...
    public void multiply(Rational r1, Rational r2){
        int newNumM = r1.getNum() * r2.getNum(); 
        int newDenM = r1.getDen() * r2.getDen();
        firstNum = newNumM; 
        firstDen = newDenM;
    }
    
    public void divide(Rational r1, Rational r2){
        int newNumD = r1. getNum() *r2.getDen();
        int newDenD = r1.getDen() * r2.getNum();
        firstNum = newNumD;
        firstDen = newDenD;
    }
    
    public void add(Rational r1, Rational r2){
        int newNumA = r1.getNum() * r2.getDen() + r2.getNum() * r1.getDen();
        int newDenA = r1.getDen() * r2.getDen();
        firstNum = newNumA;
        firstDen = newDenA;
    }
    
    public void subtract(Rational r1, Rational r2){
       int newNumS = r1.getNum() * r2.getDen() - r2.getNum() * r1.getDen();
       int newDenS = r1.getDen() * r2.getDen();
       firstNum = newNumS;
       firstDen = newDenS; 
    }
